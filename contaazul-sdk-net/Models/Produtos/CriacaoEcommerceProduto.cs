...
{
    /// <summary>Informações de e-commerce do produto na criação.</summary>
    public sealed class CriacaoEcommerceProduto
    {
        /// <summary>Categoria do produto no e-commerce.</summary>
        [JsonPropertyName("categoria_ecommerce")]
        public ReferenciaIdProduto CategoriaEcommerce { get; set; }

        /// <summary>Condição do produto para e-commerce (<c>NOVO</c> ou <c>USADO</c>).</summary>
        ...
        public ReferenciaIdProduto Marca { get; set; }
